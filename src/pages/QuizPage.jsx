...
const QuizPage = () => {
    ...
    const handleQuizCountChange = (e) => {
        setQuizCount(parseInt(e.target.value));
    };

    const handleSubmit = () => {
        if (!selectedMajorId || !selectedSubjectId || !selectedQuizType || !quizCount) {
            alert('모든 항목을 선택하고 퀴즈 개수를 입력해주세요.');
            return;
        }

        // QuizTakingPage로 선택된 값들을 state로 전달
        ...
        <div className="min-h-screen bg-white">
            ...
            <div className="flex flex-col items-center justify-center min-h-[calc(100vh-80px)] p-4">
                <div className="w-full max-w-md text-center mb-12">
                    ...
                    <p className="text-gray-600 text-lg">원하는 전공, 과목, 문제 유형을 선택하고 퀴즈를 시작하세요.</p>
                </div>
                ...
                <div className="w-full max-w-md space-y-8 mb-8">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            min="1"
                            placeholder="풀고 싶은 퀴즈 개수를 입력하세요"
                        />
                    </div>
                </div>
